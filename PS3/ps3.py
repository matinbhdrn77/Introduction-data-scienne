...
class RectangularRoom(object):
    ...
    def is_position_in_room(self, pos):
        ...
        """
        x_condition = pos.get_x() < self.width and pos.get_x() >= 0
        y_condition = pos.get_y() < self.height and pos.get_y() >= 0
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for t in range(num_trials):
        ...
        # anim.done()
    return sum(total_timestamp) / len(total_timestamp)
...
#       of a 20x20 room?
# print ('avg time steps: ' + str(run_simulation(1, 1.0, 1, 5, 5, 3, 0.8, 50, StandardRobot)))
# print ('avg time steps: ' + str(run_simulation(1, 1.0, 1, 5, 5, 3, 0.8, 50, FaultyRobot)))
#
...
# print ('avg time steps: ' + str(run_simulation(1, 1.0, 1, 50, 6, 3, 0.8, 50, StandardRobot)))
# print("FaultyBot")
...
# print ('avg time steps: ' + str(run_simulation(1, 1.0, 1, 50, 6, 3, 0.8, 50, FaultyRobot)))
